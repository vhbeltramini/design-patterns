...
public class CadastroContato extends JFrame {
	...
	private void initComponents() {
		...
		jrInternet.setActionCommand("builder.ConstruirParaInternet");
		...
		jrTelefone.setActionCommand("builder.ConstruirParaTelefone");
		jrTelefone.addActionListener(arg0 -> {
			desabilitarTudo();
		...
		jrCompleto.setActionCommand("builder.ConstruirPessoa");
		...
		jb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					// Chamar o construir do Director passando como parametro os valores dos campos
